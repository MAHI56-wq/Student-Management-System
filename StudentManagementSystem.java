...
public class StudentManagementSystem {
    ...
    public static void add5Students(List<Student> students) {
        students.add(new Student(123456, "John", "Computer Science"));
        students.add(new Student(234567, "Emily", "Mathematics"));
        students.add(new Student(345678, "Michael", "Physics"));
        students.add(new Student(456789, "Sarah", "Biology"));
        students.add(new Student(567890, "David", "Chemistry"));
    }
}
